...
public class MTree {
	...
	Node<String> rootForBTree = new Node<String>(null);
...
//        	rootForBTree = cNodes.get(0);
        ...
        do{
        	...
        	String varibale = "nodeBTree" + nodeIndex ;
        	
        	Node<String> varibale = new Node<String>(null);
        	nodeBTree<nodeIndex> = lNode.hashValue;
        	nodeBTree[nodeIndex+1] = rNode.hashValue;
        	numberNumber+=2;
